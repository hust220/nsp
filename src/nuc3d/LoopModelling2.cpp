...
LoopModelling2::LoopModelling2(string type): _type(type) {
    char *lib = getenv("NSP");
    assert(lib);
    _lib = string() + lib;
...
Model LoopModelling2::operator ()(string seq, string ss, string constraint_file, int num) {
	_seq = seq;
	_ss = ss;
...
Model LoopModelling2::to_all_atom(const MatrixXf &scaffold) {
...
void LoopModelling2::set_constraints() {
...
MatrixXf LoopModelling2::apply_constraints(const MatrixXf &scaffold) {
...
std::vector<std::vector<std::vector<int>>> LoopModelling2::read_constraints_file() {
...
MatrixXf LoopModelling2::read_constraints_pos(std::string type, int layer_nums) {
...
MatrixXf LoopModelling2::read_constraints_par(std::string type, int layer_nums) {
