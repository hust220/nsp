...
class DG : public virtual dg::Job, public virtual dg::CG, public virtual dg::MC {
public:
    DG() = default;
    ...
    DG(const DistBoundType &dist_bound, const DihBound &dih_bound) : DG(dist_bound) {
    ...
    Mat operator ()() {
        ...
        Trace::log("DG Energy (", _dist_en, ' ', _dih_en, ").\n");
        return c;
    }
